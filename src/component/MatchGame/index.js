...
class MatchGame extends Component {
  ...
  updateView = () => {
    this.setState({gameOver: false, sec: 60, score: 0})
    this.timerId = setInterval(this.statusChange, 1000)
  }
  ...
  render() {
    const {activeTabId, gamePic, score, sec, gameOver} = this.state
    ...
    return (
      <div className="bg-container">
        ...
        {gameOver ? (
          <div className="body-container">{this.renderOnGameOver()}</div>
        ) : (
          <div className="body-container">
            <img src={gamePic.imageUrl} alt="match" className="game-pic" />
            ...
            <ul className="thumbnail-container">
              {thumbnailItems.map(eachThumbNail => (
                <ThumbNailItems
                  thumbnails={eachThumbNail}
